              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <div class="input-group mb-3">
                    <input id="cedulaCliente" name="cedulaCliente" type="text" class="form-control" placeholder="Cedula" aria-label="Username" />
                    <span class="input-group-text">@</span>
                    <input id="fechaCita" name="fechaCita" type="date" class="form-control" placeholder="Fecha" aria-label="Server" />
                  </div>
